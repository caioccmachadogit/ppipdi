...
public class AdapterCarregamentoPlanta extends ArrayAdapter<CarregamentoPlanta>{
	private List<CarregamentoPlanta> items;
	private int layoutResourceId;
	private Context context;

	
	public AdapterCarregamentoPlanta(Context context, int layoutResourceId,List<CarregamentoPlanta> items) {
	...
	public static class ViewHolder{
    	TextView etiqueta;
    	ImageView editar;
    	CarregamentoPlanta carregamento;
    }
