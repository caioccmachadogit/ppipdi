...
public class AsyncConfirmarEnvOS extends AsyncTask<Os, String, String>{
	private ProgressDialog pd;
	private Activity activity;
	private TarefaInterfaceEnviar ti;
	
	public AsyncConfirmarEnvOS(Activity activity, TarefaInterfaceEnviar ti){
	...
	protected void onPostExecute(String result) 
	{
		...
		EnviarOSFragment.cEnvioConfEnvOs++;
